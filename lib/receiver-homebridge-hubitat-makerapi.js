...
var receiver_makerapi = {
    start: function(platform) {
        ...
        server.listen(platform.local_port || 20010, function() {
        ...
        platform.api.connect("http://" + platform.local_ip + ":" + platform.local_port + "/event").then(function (data) {
            ...
            platform.log.error('Cant activate MakerAPI event stream, check the MakerAPI logs and your config file. I am going to stop here', error);
            process.exit(1);
        });
