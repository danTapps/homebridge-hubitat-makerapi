...
var receiver_makerapi = {
    start: function(platform) {
        ...
        function processChangeEvent(element, changeEventType) {
            ...
            if (platform.config.dedupe_change_events_ms) {
                ...
                dedupe_change_event_map[key].timer = setTimeout(function() {
                    ...
                    platform.log('Deduped Change Event (' + changeEventType + '):', '(' + element['displayName'] + ':' + element['device'] + ') [' + (element['attribute'] ? element['attribute'].toUpperCase() : 'unknown') + '] is ' + element['value']);
