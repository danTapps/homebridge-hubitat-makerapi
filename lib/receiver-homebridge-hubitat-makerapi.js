        ...
        function connect(platform) {
            ...
            function webSocketCheck() {
                ...
                wsWebSocketCheckTimeout = setTimeout(function() {
                    platform.log.error('Did not receive response to websocket communication test, close socket');
                    platform.log.error(util.inspect(ws, false, null, true));
